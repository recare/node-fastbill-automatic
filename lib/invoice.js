...
var BaseBroker = require('./fastbill_api');
...
util.inherits(Invoice, BaseBroker);
 ...
 *
 * 
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/invoice.html#invoice.get
 * 
 * Possible options:
 * 
 ...
 * 
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/invoice.html#invoice.create
 *
 * Usage example:
 * 
 *     var Invoice = {
 ...
 *     }];
 *
 *     node-fastbill-automatic.Invoice.create(Invoice, function (err, id) {
 *         if (err) {
 ...
 * 
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/invoice.html#invoice.update
 * 
 * Usage example:
 * 
 *     var invoice = {
 ...
 *     };
 *
 *     node-fastbill-automatic.Invoice.update(1, invoice, function (err) {
 *         if (err) {
 *             return console.error(err);
 *         }
 *     });
 ...
 * Deletes an Invoice.
 * 
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/invoice.html#invoice.delete
 * 
 * Usage example:
 *
 *     node-fastbill-automatic.Invoice.delete(1, function (err) {
 *         if (err) {
 *             return console.error(err);
 *         }
 *     });
 ...
 * Usage example:
 *
 *     node-fastbill-automatic.Invoice.complete(1, function (err) {
 *         if (err) {
 *             return console.error(err);
 *         }
 *     });
 ...
 * Cancels an Invoice.
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/invoice.html#invoice.cancel
 *
 * Usage example:
 *
 *     node-fastbill-automatic.Invoice.cancel(1, function (err) {
 *         if (err) {
 *             return console.error(err);
 *         }
 *     });
 ...
 * Requires paid credits on your node-fastbill-automatic account.
 *
 * Returns the number of credits left to sign invoices.
 *
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/invoice.html#invoice.sign
 *
 * Usage example:
 *
 *     node-fastbill-automatic.Invoice.sign(1, function (err, credits) {
 *         if (err) {
 *             return console.error(err);
 *         }
 *
