 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.get
 *
 * Possible options:
 *
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.create
 *
 * Usage example:
 *
 *     var subscription = {
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.update
 *
 *  Usage example:
 *
 *     var modification = {
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.setusagedata
 *
 * Usage example:
 *
 *     var usage = {
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.changearticle
 *
 * Usage example:
 *
 *     var modification = {
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.get_usage_data
 *
 * Usage example:
 *
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.deleteusagedata
 *
 * Usage example:
 *
 *
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.delete
 *
 * Usage example:
 *
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.reactivate
 *
 * Usage example:
 *
 ...
 * will be returned.
 *
 * http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.cancel
 *
 * Usage example:
 *
 *     node-fastbill-automatic.subscription.delete(1, function (err) {
...
Subscription.prototype.cancel = function cancel (id, callback) {
    ...
    function onResult (err, cancellation_date) {
        if (err) {
            return callback(err);
        }

        callback(null, cancellation_date);
    }
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.getupcomingamount
 *
 * Usage example:
 *
 *     var filters = {
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.renew
 *
 * Usage example:
 *
 ...
 *
 * See: http://www.node-fastbill-automatic-automatic.com/api/automatic/en/subscription.html#subscription.setaddon
 *
 * Usage example:
 *
 *      var addon = {
